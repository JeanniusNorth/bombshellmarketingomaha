...
export function BlogPreview() {
  return (
    <section className="bg-[#000000] py-20 md:py-28" data-testid="blog-preview-section">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <Link
            href="/blog"
            className="mt-4 md:mt-0 text-white/60 hover:text-[#ffffff] transition-colors text-sm font-sans flex items-center gap-1 group"
          ...
          {recentArticles.map((article, index) => (
            ...
            >
              ...
              >
                <div className="relative overflow-hidden mb-4">
                  ...
                  <div className="absolute top-3 left-3">
                    <span
                      ...
                      style={{
                        backgroundColor: categoryColors[article.category]?.bg || "#ffffff",
                ...
                <h3 className="text-white font-display text-lg md:text-xl leading-tight mb-2 group-hover:text-[#ffffff] transition-colors">
                  {article.title}
                </h3>
                ...
                <span className="inline-flex items-center gap-1 text-[#ffffff] text-xs font-sans uppercase tracking-wider mt-4 group-hover:gap-2 transition-all">
                  Read More
