      ...
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-black/10">
          {services.map((service, index) => (
            ...
            >
              ...
              >
                <h3 className="text-3xl md:text-5xl lg:text-6xl font-display text-[#000000] group-hover:text-[#000000] transition-colors leading-none">
                  {service.title}
                </h3>
                <div
                  className={`w-10 h-10 md:w-12 md:h-12 rounded-full border-2 border-[#000000] flex items-center justify-center shrink-0 transition-all duration-300 group-hover:border-[#000000] group-hover:text-[#000000] ${
                    openIndex === index ? "rotate-45 bg-[#000000] border-[#000000] text-white" : "text-[#000000]"
                  }`}
                >
                  ...
                  >
                    <div className="pb-8 md:pb-12 grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                      <div className="flex flex-col justify-between">
                        <div>
                          <p className="text-[#000000]/70 text-base md:text-lg leading-relaxed mb-6 max-w-md">
                            {service.description}
                          </p>
                          <div className="grid grid-cols-2 gap-x-8 gap-y-2 mb-8">
                            {service.details.map((detail, i) => (
                              <span key={i} className="text-[#000000]/50 text-sm py-1">
                                {detail}
                              </span>
                            ))}
                          </div>
                        ...
                        <Link
                          ...
                          className="inline-flex items-center gap-2 text-[#000000] text-sm font-bold uppercase tracking-wider hover:gap-3 transition-all group/link"
        ...
        <div className="flex justify-center mt-12">
          <Link
            href="/services"
            onClick={() => window.scrollTo(0, 0)}
            className="group px-8 py-4 rounded-full bg-[#000000] text-white border border-[#000000] hover:bg-[#ffffff] hover:text-black hover:border-[#ffffff] transition-all text-xs font-bold uppercase tracking-widest flex items-center gap-3"
