...
export function CaseStudy() {
  return (
    <section className="bg-[#1a1a1a] py-24 text-[#111111] font-sans" data-testid="case-study-section">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative overflow-hidden rounded-2xl">
              ...
              <div className="absolute bottom-6 left-6">
                <p className="text-[#111111]/80 text-sm mb-1">See the story</p>
                <h3 className="text-[#111111] text-2xl font-display uppercase">Merch Club</h3>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-[#2B2B2B]/60 text-lg mb-6">Founder at Merch Club</p>
            ...
            <Link href="/portfolio" onClick={() => window.scrollTo(0, 0)}>
              <button 
                className="bg-[#1FA88F] text-[#111111] px-8 py-4 rounded-full font-bold uppercase tracking-wider hover:bg-white transition-colors flex items-center gap-2 group mb-12"
            ...
            <div className="grid grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-[#2B2B2B]/60 text-sm">Social media engagement growth</p>
              </div>
              <div>
                <p className="text-4xl md:text-5xl font-display text-[#111111] mb-2">3x</p>
                <p className="text-[#2B2B2B]/60 text-sm">Increase in website traffic after redesign</p>
              </div>
            </div>
