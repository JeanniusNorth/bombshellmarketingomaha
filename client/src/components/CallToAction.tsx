...
export function CallToAction() {
  ...
  return (
    <section className="bg-[#0a0a0a] py-20 text-white relative overflow-hidden" data-testid="cta-section">
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button 
            ...
            className="group px-8 py-4 bg-[#2563EB] text-white border border-[#2563EB] hover:bg-white hover:border-white transition-all text-xs font-bold uppercase tracking-widest flex items-center justify-center gap-2"
