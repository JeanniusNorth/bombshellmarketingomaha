      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <button onClick={openContactModal} className="group px-6 py-3 border border-black hover:bg-black hover:text-white transition-all text-black text-xs font-bold uppercase tracking-widest flex items-center gap-2">
            Contact Us
            <div className="w-5 h-5 rounded-full bg-black text-[#1A1A1A] group-hover:bg-white group-hover:text-black flex items-center justify-center transition-colors">
          ...
          <div className="w-full h-full flex flex-col">
             ...
             <div className="bg-black text-[#1A1A1A] px-4 py-3 flex items-center justify-between border-b border-[#1A1A1A]/10">
                <div className="flex items-center gap-3">
                   ...
                   <a href={item.url} target="_blank" rel="noopener noreferrer" className="text-xs text-[#2A2A2A]/60 hover:text-primary flex items-center gap-1">
