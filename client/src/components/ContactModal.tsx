      ...
      <DialogContent className="max-w-xl w-[95vw] max-h-[90vh] overflow-y-auto p-0 bg-white border border-gray-200 rounded-lg shadow-2xl gap-0">
        ...
        {isSubmitted ? (
          <div className="p-8 md:p-12 text-center">
            ...
            <button 
              onClick={handleClose}
              className="inline-flex items-center gap-2 px-8 py-3 bg-[#000000] text-white font-semibold rounded-md hover:bg-[#1a18a0] transition-colors"
            >
              Close
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-8">
            <div className="flex items-start gap-4 mb-6">
              <div className="w-10 h-10 bg-[#000000]/10 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-gray-200 focus:border-[#000000] focus:ring-2 focus:ring-[#000000]/20 text-black px-4 py-2.5 rounded-md outline-none transition-all placeholder:text-gray-400"
                  placeholder="John Smith"
                />
              </div>
              <div>
                <label htmlFor="modal-email" className="block text-gray-700 text-sm font-medium mb-2">
                  Work Email <span className="text-[#000000]">*</span>
                </label>
                <input
                  type="email"
                  id="modal-email"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                <label htmlFor="modal-company" className="block text-gray-700 text-sm font-medium mb-2">
                  Company Name <span className="text-[#000000]">*</span>
                </label>
                <input
                  type="text"
                  id="modal-company"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                <label htmlFor="modal-service" className="block text-gray-700 text-sm font-medium mb-2">
                  Service Interest <span className="text-[#000000]">*</span>
                </label>
                <select
                  id="modal-service"
                  name="service"
                  ...
                  onChange={handleChange}
                  className="w-full bg-white border border-gray-200 focus:border-[#000000] focus:ring-2 focus:ring-[#000000]/20 text-black px-4 py-2.5 rounded-md outline-none transition-all appearance-none cursor-pointer"
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full bg-white border border-gray-200 focus:border-[#000000] focus:ring-2 focus:ring-[#000000]/20 text-black px-4 py-2.5 rounded-md outline-none transition-all resize-none placeholder:text-gray-400"
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
              ...
              <button
                ...
                className="px-6 py-2.5 bg-[#000000] text-white font-medium rounded-md hover:bg-[#1a18a0] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {isSubmitting ? (
                  <>
