      ...
      <DialogContent className="max-w-xl w-[95vw] max-h-[90vh] overflow-y-auto p-0 bg-white border border-gray-200 rounded-lg shadow-2xl gap-0">
        ...
        {isSubmitted ? (
          <div className="p-8 md:p-12 text-center">
            <div className="w-16 h-16 bg-[#D9A3B0] rounded-full flex items-center justify-center mx-auto mb-6">
              <Send className="w-8 h-8 text-[#1A1A1A]" />
            </div>
            ...
            <button 
              onClick={handleClose}
              className="inline-flex items-center gap-2 px-8 py-3 bg-[#D9A3B0] text-[#1A1A1A] font-semibold rounded-md hover:bg-[#D9A3B0] transition-colors"
            >
              Close
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-8">
            <div className="flex items-start gap-4 mb-6">
              <div className="w-10 h-10 bg-[#D9A3B0]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                <MessageSquare className="w-5 h-5 text-[#D9A3B0]" />
              </div>
              <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                <label htmlFor="modal-fullName" className="block text-gray-700 text-sm font-medium mb-2">
                  Full Name <span className="text-[#D9A3B0]">*</span>
                </label>
                <input
                  type="text"
                  id="modal-fullName"
                  ...
                  className="w-full bg-white border border-gray-200 focus:border-[#D9A3B0] focus:ring-2 focus:ring-[#D9A3B0]/20 text-black px-4 py-2.5 rounded-md outline-none transition-all placeholder:text-gray-400"
                  placeholder="John Smith"
                />
              </div>
              <div>
                <label htmlFor="modal-email" className="block text-gray-700 text-sm font-medium mb-2">
                  Work Email <span className="text-[#D9A3B0]">*</span>
                </label>
                <input
                  type="email"
                  id="modal-email"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                <label htmlFor="modal-company" className="block text-gray-700 text-sm font-medium mb-2">
                  Company Name <span className="text-[#D9A3B0]">*</span>
                </label>
                <input
                  type="text"
                  id="modal-company"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                <label htmlFor="modal-service" className="block text-gray-700 text-sm font-medium mb-2">
                  Service Interest <span className="text-[#D9A3B0]">*</span>
                </label>
                <select
                  id="modal-service"
                  name="service"
                  ...
                  onChange={handleChange}
                  className="w-full bg-white border border-gray-200 focus:border-[#D9A3B0] focus:ring-2 focus:ring-[#D9A3B0]/20 text-black px-4 py-2.5 rounded-md outline-none transition-all appearance-none cursor-pointer"
            ...
            <div className="mb-6">
              ...
              <textarea
                ...
                onChange={handleChange}
                className="w-full bg-white border border-gray-200 focus:border-[#D9A3B0] focus:ring-2 focus:ring-[#D9A3B0]/20 text-black px-4 py-2.5 rounded-md outline-none transition-all resize-none placeholder:text-gray-400"
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
              ...
              <button
                ...
                className="px-6 py-2.5 bg-[#D9A3B0] text-[#1A1A1A] font-medium rounded-md hover:bg-[#D9A3B0] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
              >
                {isSubmitting ? (
                  <>
                    <div className="w-4 h-4 border-2 border-[#1A1A1A]/15 border-t-white rounded-full animate-spin" />
                    Sending...
                  </>
                ) : (
                  "Let's Talk"
