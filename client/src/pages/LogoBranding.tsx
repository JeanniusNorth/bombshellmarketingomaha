          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-12">
              <div className="text-center">
                <div className="text-4xl font-display text-[#000000] mb-2">200+</div>
                <div className="text-sm text-black/50 uppercase tracking-wider">Logos Designed</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-display text-[#000000] mb-2">50+</div>
                <div className="text-sm text-black/50 uppercase tracking-wider">Brand Systems</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-display text-[#000000] mb-2">15+</div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {brandingServices.map((service, index) => (
              ...
              >
                <service.icon className={`w-10 h-10 mb-6 ${service.highlight ? 'text-primary' : 'text-[#000000]'}`} />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6 text-black/60 text-lg leading-relaxed">
              ...
              <p>
                A great logo is just the beginning. We build complete brand ecosystems that extend across every touchpoint—from your <Link href="/web-design" className="text-[#000000] hover:underline font-semibold">custom website design</Link> to print materials, signage, and social media. Our team also offers <Link href="/brand-photography" className="text-[#000000] hover:underline font-semibold">professional brand photography</Link> to complement your visual identity with authentic, on-brand imagery that tells your story.
              </p>
              <p>
