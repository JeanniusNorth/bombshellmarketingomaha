          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <div className="text-3xl font-display text-[#000000] mb-1">+250%</div>
                  <div className="text-xs text-black/50 uppercase tracking-wider">Increase in Monthly Leads</div>
                </div>
                <div>
                  <div className="text-3xl font-display text-[#000000] mb-1">25+</div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-[#000000] text-white rounded-full flex items-center justify-center text-2xl font-display mx-auto mb-4">
                01
              </div>
