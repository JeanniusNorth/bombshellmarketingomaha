    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#D9A3B0] pt-32 pb-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-[#2A2A2A]/70 max-w-2xl mx-auto mb-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <div className="text-3xl font-display text-[#D9A3B0] mb-1">+250%</div>
                  <div className="text-xs text-black/50 uppercase tracking-wider">Increase in Monthly Leads</div>
                </div>
                <div>
                  <div className="text-3xl font-display text-[#D9A3B0] mb-1">25+</div>
      ...
      {/* Services Grid */}
      <section className="py-20 bg-[#D9A3B0] relative overflow-hidden">
        <div className="absolute inset-0 opacity-20 pointer-events-none mix-blend-overlay" 
             style={{ backgroundImage: 'url("https://www.transparenttextures.com/patterns/noise.png")' }}>
        </div>
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-display text-[#1A1A1A] uppercase mb-4">
              Our Strategy Services
            </h2>
            <p className="text-[#2A2A2A]/60 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {strategyServices.map((service, index) => {
              ...
              return (
                <div 
                  key={index}
                  className={`p-8 ${service.highlight ? 'bg-primary text-white' : 'bg-[#1A1A1A]/5 text-white'} transition-all hover:scale-[1.02]`}
                >
                  ...
                  <p className={`text-sm leading-relaxed ${service.highlight ? 'text-black/70' : 'text-[#2A2A2A]/70'}`}>
                    {service.description}
                  </p>
                </div>
              );
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-[#D9A3B0] text-[#1A1A1A] rounded-full flex items-center justify-center text-2xl font-display mx-auto mb-4">
                01
              </div>
