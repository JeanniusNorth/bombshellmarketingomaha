          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-12">
              <div className="text-center">
                <div className="text-4xl font-display text-[#0a0a0a] mb-2">150+</div>
                <div className="text-sm text-black/50 uppercase tracking-wider">Strategies Built</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-display text-[#0a0a0a] mb-2">3x</div>
                <div className="text-sm text-black/50 uppercase tracking-wider">Avg ROI Increase</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-display text-[#0a0a0a] mb-2">20+</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div>
                  <div className="text-3xl font-display text-[#0a0a0a] mb-1">+250%</div>
                  <div className="text-xs text-black/50 uppercase tracking-wider">Increase in Monthly Leads</div>
                </div>
                <div>
                  <div className="text-3xl font-display text-[#0a0a0a] mb-1">25+</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {strategyServices.map((service, index) => {
              ...
              return (
                <div 
                  key={index}
                  className={`p-8 ${service.highlight ? 'bg-primary text-white' : 'bg-white/10 text-white'} transition-all hover:scale-[1.02]`}
                >
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-[#0a0a0a] text-white rounded-full flex items-center justify-center text-2xl font-display mx-auto mb-4">
                01
              </div>
